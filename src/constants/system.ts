...
const DEFAULT_PREFIX = `You are Ocean CLI, an AI-powered command-line assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Ocean CLI, an AI-powered command-line assistant, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are an AI agent, built on Anthropic's Claude Agent SDK.`
