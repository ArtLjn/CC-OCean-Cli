      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              OCean Cli&apos;s functionality (eg. to reduce the risk of bugs
