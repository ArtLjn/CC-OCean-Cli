...
// Always ask when OCean Cli tries to edit its own config files
 ...
 * This is a per-user temporary directory used by OCean Cli for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by OCean Cli)
