...
const APP_NAME = 'OCean Cli URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'OCean Cli URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>OCean Cli Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for OCean Cli
