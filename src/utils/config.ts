...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when OCean Cli was first started on this machine
  ...
  // OCean Cli usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first OCean Cli OAuth token
  ...
  // OCean Cli hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
