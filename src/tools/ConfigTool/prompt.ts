...
export const DESCRIPTION = 'Get or set OCean Cli configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set OCean Cli configuration settings.

  View or change OCean Cli settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
